...
Using yarn.
```sh
yarn add @arunabhdas/chat-ui-kit-dark-mode-styles
```

Using npm.
```sh
npm install @arunabhdas/chat-ui-kit-dark-mode-styles
````

## Usage

```jsx
import styles from '@arunabhdas/chat-ui-kit-dark-mode-styles/dist/default/styles.min.css';
```

For more information please visit [Chat UI Kit React repository](https://github.com/arunabhdas/chat-ui-kit-react)
or check our friendly [Storybook](https://arunabhdas.io/storybook/react/).
